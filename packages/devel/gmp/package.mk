...
# gmplib.org refuses connections from CI often enough to break builds; the GNU
# mirror serves a byte-identical tarball, which PKG_SHA256 above verifies.
...
pre_configure_target() {
  ...
  export CFLAGS="${CFLAGS} -std=gnu11 -Wno-error=implicit-function-declaration -Wno-error=incompatible-pointer-types"
